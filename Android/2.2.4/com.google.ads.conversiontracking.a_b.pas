...
////////////////////////////////////////////////////////////////////////////////
unit com.google.ads.conversiontracking.a_b;
...
type
  ...
  Ja_bClass = interface(JObjectClass)
    ['{D1AA0CA7-A693-44C5-9E01-1C0339B7CF22}']
    ...
    function getActivityInfo(component : JComponentName; flags : Integer) : JActivityInfo; cdecl;// (Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo; A: $1
    ...
    function getProviderInfo(component : JComponentName; flags : Integer) : JProviderInfo; cdecl;// (Landroid/content/ComponentName;I)Landroid/content/pm/ProviderInfo; A: $1
    function getReceiverInfo(component : JComponentName; flags : Integer) : JActivityInfo; cdecl;// (Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo; A: $1
    ...
    function getServiceInfo(component : JComponentName; flags : Integer) : JServiceInfo; cdecl;// (Landroid/content/ComponentName;I)Landroid/content/pm/ServiceInfo; A: $1
    ...
    function init(JContextparam0 : JContext) : Ja_b; cdecl;                     // (Landroid/content/Context;)V A: $1
  ...
  [JavaSignature('com/google/ads/conversiontracking/a_b')]
  Ja_b = interface(JObject)
    ['{F5FEE95B-50C1-463E-93DD-97811D0DD718}']
    function addPermission(info : JPermissionInfo) : boolean; cdecl;            // (Landroid/content/pm/PermissionInfo;)Z A: $1
    function addPermissionAsync(info : JPermissionInfo) : boolean; cdecl;       // (Landroid/content/pm/PermissionInfo;)Z A: $1
    function canonicalToCurrentPackageNames(names : TJavaArray<JString>) : TJavaArray<JString>; cdecl;// ([Ljava/lang/String;)[Ljava/lang/String; A: $1
    function checkPermission(permName : JString; pkgName : JString) : Integer; cdecl;// (Ljava/lang/String;Ljava/lang/String;)I A: $1
  ...
  TJa_b = class(TJavaGenericImport<Ja_bClass, Ja_b>)
  end;
